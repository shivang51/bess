...
namespace material_color_utilities {
     ...
     *
     * <p>Analogous colors, complementary color, and cache to efficiently,
     * lazily, generate data for calculations when needed.
     */
    class TemperatureCache {
      public:
        /**
         * Create a cache that allows calculation of ex. complementary and
         * analogous colors.
         *
         ...
         * History of this shows intent as a color that is just as cool-warm as
         * the input color is warm-cool.
         */
        Hct GetComplement();
         ...
         * wheel divided into 12 sections. This method allows provision of
         * either of those values.
         *
         * <p>Behavior is undefined when count or divisions is 0. When divisions
         * < count, colors repeat.
         *
         * @param count The number of colors to return, includes the input
         * color.
         ...
         *
         * <p>Color science has researched emotion and harmony, which art uses
         * to select colors. Warm-cool is the foundation of analogous and
         * complementary colors. See: - Li-Chen Ou's Chapter 19 in Handbook of
         * Color Psychology (2015). - Josef Albers' Interaction of Color
         * chapters 19 and 21.
         *
         ...
         * 130.<br>
         * - Upper bound: 8.61. Chroma is infinite. Assuming max of Lab chroma
         * 130.
         */
      ...
      private:
        ...
        /** Determines if an angle is between two other angles, rotating
         * clockwise. */
