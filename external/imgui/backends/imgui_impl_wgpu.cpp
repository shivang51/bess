...
//  2025-06-12: Added support for ImGuiBackendFlags_RendererHasTextures, for
//  dynamic font atlas. (#8465) 2025-02-26: Recreate image bind groups during
//  render. (#8426, #8046, #7765, #8027) + Update for latest webgpu-native
//  changes. 2024-10-14: Update Dawn support for change of string usages.
//  (#8082, #8083) 2024-10-07: Expose selected render state in
//  ImGui_ImplWGPU_RenderState, which you can access in 'void*
//  platform_io.Renderer_RenderState' during draw callbacks. 2024-10-07: Changed
//  default texture sampler to Clamp instead of Repeat/Wrap. 2024-09-16: Added
//  support for optional IMGUI_IMPL_WEBGPU_BACKEND_DAWN /
...
struct RenderResources {
    ...
    WGPUBindGroup CommonBindGroup = nullptr; // Resources bind-group to bind the
                                             // common resources to pipeline
    ImGuiStorage
