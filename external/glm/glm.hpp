...
/// - <a href="https://github.com/g-truc/glm/blob/master/manual.md">GLM
/// Manual</a>
///
/// @defgroup core Core features
///
/// @brief Features that implement in C++ the GLSL specification as closely as
/// possible.
///
...
///
/// @brief Vector types with precision qualifiers which may result in various
/// precision in term of ULPs
///
/// GLSL allows defining qualifiers for particular variables.
/// With OpenGL's GLSL, these qualifiers have no effect; they are there for
/// compatibility, with OpenGL ES's GLSL, these qualifiers do have an effect.
///
/// C++ has no language equivalent to qualifier qualifiers. So GLM provides the
/// next-best thing: a number of typedefs that use a particular qualifier.
///
...
///
/// Matrix types of with C columns and R rows where C and R are values between 2
/// to 4 included. These types have exhaustive sets of operators.
///
/// @ingroup core
///
///
...
///
/// @brief Matrix types with precision qualifiers which may result in various
/// precision in term of ULPs
///
/// GLSL allows defining qualifiers for particular variables.
/// With OpenGL's GLSL, these qualifiers have no effect; they are there for
