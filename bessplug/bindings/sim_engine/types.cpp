...
void bind_sim_engine_types(py::module_ &m) {
    ...
    py::class_<PinState>(m, "PinState")
        ...
        .def("__repr__", [](const PinState &self) {
            ...
            switch (self.state) {
            case LogicState::low: s = "LOW"; break;
            case LogicState::high: s = "HIGH"; break;
            case LogicState::unknown: s = "UNKNOWN"; break;
            case LogicState::high_z: s = "HIGH_Z"; break;
            }
    ...
    py::class_<ComponentState>(m, "ComponentState")
        ...
        .def_property(
            ...
            [](const ComponentState &self) {
                return static_cast<std::uintptr_t>(reinterpret_cast<std::uintptr_t>(self.auxData));
            },
            [](ComponentState &self, std::uintptr_t ptr_value) {
                self.auxData = reinterpret_cast<std::any *>(ptr_value);
            }
        )
        .def(
            "set_aux_pyobject",
            ...
            py::arg("obj"),
            "Attach a Python object as aux data. Returns the aux_data pointer value."
        )
        .def(
            "get_aux_pyobject",
            ...
            "Return the attached Python object if owned by Python, else None."
        )
        .def(
            "clear_aux_data",
            [](ComponentState &self) {
