...
void bind_dig_sim_driver(py::module_ &m) {
    ...
    py::class_<Digital::DigCompDef, PyDigCompDef, EvtBasedCompDef,
        ...
        .def("compute_expressions_if_needed",
             &Digital::DigCompDef::computeExpressionsIfNeeded)
