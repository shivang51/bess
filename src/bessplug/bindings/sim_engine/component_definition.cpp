...
void bind_sim_engine_component_definition(py::module_ &m) {
    py::class_<ComponentDefinition>(m, "ComponentDefinition")
        ...
        .def_property("input_pin_details", [](const ComponentDefinition &self) { return self.inputPinDetails; }, [](ComponentDefinition &self, const std::vector<PinDetails> &pins) { self.inputPinDetails = pins; self.invalidateHash(); })
        .def_property("output_pin_details", [](const ComponentDefinition &self) { return self.outputPinDetails; }, [](ComponentDefinition &self, const std::vector<PinDetails> &pins) { self.outputPinDetails = pins; self.invalidateHash(); })
        ...
        .def_property(
            ...
            [](ComponentDefinition &self, py::object callable) {
