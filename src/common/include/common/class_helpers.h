...
#define MAKE_GETTER_SETTER(type, name, varName)                                \
    const type &get##name() const { return varName; }                          \
    void set##name(const type &value) { varName = value; }                     \
    type &get##name() { return varName; }
...
#define MAKE_VGETTER_VSETTER(type, name, varName)                              \
    ...
    virtual void set##name(const type &value) { varName = value; }             \
...
#define MAKE_GETTER_SETTER_BC_AC(type, name, varName, onBeforeChange,          \
                                 onAfterChange)                                \
    const type &get##name() const { return varName; }                          \
    void set##name(const type &value) {                                        \
