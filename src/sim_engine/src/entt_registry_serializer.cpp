...
namespace Bess {
    void EnttRegistrySerializer::serialize(const entt::registry &registry,
                                           Json::Value &j) {
    ...
    void EnttRegistrySerializer::serializeEntity(const entt::registry &registry,
                                                 entt::entity entity,
                                                 Json::Value &j) {
    ...
    void EnttRegistrySerializer::serializeToPath(const entt::registry &registry,
    ...
    void EnttRegistrySerializer::deserialize(entt::registry &registry,
    ...
    entt::entity
    EnttRegistrySerializer::deserializeEntity(entt::registry &registry,
                                              const Json::Value &j) {
        const auto entity = registry.create();
        for (const auto &deserializeCB :
             m_ComponentDeserializers | std::views::values) {
    ...
    void
    EnttRegistrySerializer::deserializeFromPath(entt::registry &registry,
                                                const std::string &filename) {
