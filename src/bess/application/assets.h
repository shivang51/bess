...
namespace Bess::Assets {
    namespace Fonts {
        constexpr auto roboto = AssetID<Renderer::Font::FontFile, 1>(
            "assets/fonts/Roboto/Roboto-Regular.ttf");
        constexpr auto robotoMsdf = AssetID<Renderer::MsdfFont, 2>(
            "assets/fonts/Roboto/msdf-Roboto-Regular-32/", "Roboto-Regular");
        namespace Paths {
            constexpr auto roboto = AssetID<std::string, 1>(
                "assets/fonts/Roboto/Roboto-Regular.ttf");
            ...
            constexpr auto componentIcons = AssetID<std::string, 1>(
                "assets/fonts/icons/ComponentIcons.ttf");
    ...
    namespace Textures {
        constexpr auto shadowTexture = AssetID<Bess::Vulkan::VulkanTexture, 1>(
