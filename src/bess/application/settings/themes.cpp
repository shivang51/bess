...
namespace Bess::Config {
    ...
    void Themes::setMaterialColors(Core::Style::Brightness brightness) {
        ...
        // Shift cleanly within the container hierarchy for consistent text
        // contrast
        colors[ImGuiCol_Header] = getImVec4(themeColors.surfaceContainerLow);
        colors[ImGuiCol_HeaderHovered] =
        ...
        colors[ImGuiCol_Button] = getImVec4(themeColors.surfaceContainerHigh);
        colors[ImGuiCol_ButtonHovered] =
            getImVec4(themeColors.surfaceContainerHighest);
        ...
        // Docking
        colors[ImGuiCol_DockingPreview] = withAlpha(themeColors.primary, 0.30f);
        colors[ImGuiCol_DockingEmptyBg] = getImVec4(themeColors.surfaceDim);

        // Plots
        colors[ImGuiCol_PlotLines] = getImVec4(themeColors.primary);
        colors[ImGuiCol_PlotLinesHovered] = getImVec4(
            themeColors
                .error); // Used error color to catch attention on mouseover
        colors[ImGuiCol_PlotHistogram] = getImVec4(themeColors.secondary);
        colors[ImGuiCol_PlotHistogramHovered] = getImVec4(themeColors.primary);
        ...
        // Selection & drag-drop
        colors[ImGuiCol_TextSelectedBg] = withAlpha(themeColors.primary, 0.25f);
