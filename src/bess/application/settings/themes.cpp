...
namespace Bess::Config {
    ...
    void Themes::setBessMinimalColors() {
        ...
        colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.50f, 0.68f, 0.88f, 1.00f);
        ...
        colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.12f, 0.50f, 0.90f, 0.24f);
    ...
    void Themes::setDarkThemeColors() {
        ...
        colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4{0.30f, 0.305f, 0.31f, 1.0f};
        colors[ImGuiCol_ScrollbarGrabActive] = ImVec4{0.38f, 0.385f, 0.39f, 1.0f};
        ...
        colors[ImGuiCol_PlotHistogramHovered] = ImVec4{0.50f, 0.70f, 0.90f, 1.0f};
        ...
        colors[ImGuiCol_NavWindowingHighlight] = ImVec4{0.38f, 0.58f, 0.82f, 0.24f};
        colors[ImGuiCol_NavWindowingDimBg] = ImVec4{0.00f, 0.00f, 0.00f, 0.50f};
        colors[ImGuiCol_ModalWindowDimBg] = ImVec4{0.00f, 0.00f, 0.00f, 0.55f};
    }
    ...
    void Themes::setFluentUIColors() {
        ...
        colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.60f, 0.60f, 0.60f, 0.40f);
    ...
    void Themes::setBessLightColors() {
        ...
        colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.77f, 0.77f, 0.78f, 1.00f);
        ...
        // Check / Grab / Slider
        colors[ImGuiCol_CheckMark] = ImVec4(0.12f, 0.42f, 0.72f, 1.00f); // softer accent blue
        ...
        colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.20f, 0.60f, 0.38f, 1.00f);
        ...
        colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.12f, 0.42f, 0.72f, 0.30f);
