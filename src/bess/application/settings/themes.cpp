...
namespace Bess::Config {
    ...
    void Themes::setBessLightColors() {
        ...
        colors[ImGuiCol_PopupBg] = ImVec4(1.00f, 1.00f, 1.00f, 0.97f);
        colors[ImGuiCol_Border] = ImVec4(0.80f, 0.80f, 0.82f, 1.00f);
        colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);

        // Frames & widgets
        colors[ImGuiCol_FrameBg] = ImVec4(0.99f, 0.99f, 0.995f, 1.00f);
        colors[ImGuiCol_FrameBgHovered] = ImVec4(0.96f, 0.97f, 0.99f, 1.00f);
        colors[ImGuiCol_FrameBgActive] = ImVec4(0.94f, 0.96f, 0.99f, 1.00f);

        colors[ImGuiCol_TitleBg] = ImVec4(0.94f, 0.94f, 0.95f, 1.00f);
        colors[ImGuiCol_TitleBgActive] = ImVec4(0.92f, 0.92f, 0.93f, 1.00f);
        colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.98f, 0.98f, 0.99f, 1.00f);
        ...
        colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.66f, 0.66f, 0.70f, 1.00f);
        colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.55f, 0.55f, 0.60f, 1.00f);

        colors[ImGuiCol_ResizeGrip] = ImVec4(0.76f, 0.76f, 0.78f, 1.00f);
        colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.64f, 0.64f, 0.68f, 1.00f);
        colors[ImGuiCol_ResizeGripActive] = ImVec4(0.52f, 0.52f, 0.56f, 1.00f);

        // Buttons
        colors[ImGuiCol_Button] = ImVec4(0.98f, 0.98f, 0.99f, 1.00f);
        colors[ImGuiCol_ButtonHovered] = ImVec4(0.87f, 0.90f, 0.95f, 1.00f);
        colors[ImGuiCol_ButtonActive] = ImVec4(0.78f, 0.84f, 0.92f, 1.00f);

        // Tabs
        colors[ImGuiCol_Tab] = ImVec4(0.96f, 0.96f, 0.97f, 1.00f);
        colors[ImGuiCol_TabHovered] = ImVec4(0.90f, 0.91f, 0.94f, 1.00f);
        colors[ImGuiCol_TabActive] = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
        colors[ImGuiCol_TabUnfocused] = ImVec4(0.96f, 0.96f, 0.96f, 1.00f);
        colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.98f, 0.98f, 0.99f, 1.00f);

        // Headers / Collapsing headers
        colors[ImGuiCol_Header] = ImVec4(0.93f, 0.93f, 0.95f, 1.00f);
        colors[ImGuiCol_HeaderHovered] = ImVec4(0.86f, 0.88f, 0.92f, 1.00f);
        colors[ImGuiCol_HeaderActive] = ImVec4(0.78f, 0.83f, 0.90f, 1.00f);

        // Separators
        colors[ImGuiCol_Separator] = ImVec4(0.85f, 0.85f, 0.86f, 1.00f);
        colors[ImGuiCol_SeparatorHovered] = ImVec4(0.70f, 0.75f, 0.78f, 1.00f);
        colors[ImGuiCol_SeparatorActive] = ImVec4(0.60f, 0.65f, 0.68f, 1.00f);

        // Check / Grab / Slider
        colors[ImGuiCol_CheckMark] = ImVec4(0.08f, 0.50f, 0.90f, 1.00f); // accent blue
        colors[ImGuiCol_SliderGrab] = ImVec4(0.72f, 0.72f, 0.74f, 1.00f);
        colors[ImGuiCol_SliderGrabActive] = ImVec4(0.60f, 0.60f, 0.64f, 1.00f);

        // Docking
        colors[ImGuiCol_DockingPreview] = ImVec4(0.08f, 0.50f, 0.90f, 0.70f);
        colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.96f, 0.96f, 0.97f, 1.00f);

        // Plots
        colors[ImGuiCol_PlotLines] = ImVec4(0.12f, 0.44f, 0.88f, 1.00f);
        colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.08f, 0.50f, 0.90f, 1.00f);
        colors[ImGuiCol_PlotHistogram] = ImVec4(0.12f, 0.60f, 0.30f, 1.00f);
        colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.10f, 0.70f, 0.35f, 1.00f);
        ...
        colors[ImGuiCol_TableRowBgAlt] = ImVec4(0.98f, 0.98f, 0.99f, 1.00f);

        // Selection / Drag & drop
        colors[ImGuiCol_TextSelectedBg] = ImVec4(0.08f, 0.50f, 0.90f, 0.12f);
        colors[ImGuiCol_DragDropTarget] = ImVec4(0.08f, 0.50f, 0.90f, 0.20f);

        // Navigation highlights & windowing overlays
        colors[ImGuiCol_NavHighlight] = ImVec4(0.08f, 0.50f, 0.90f, 0.20f);
        colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.08f, 0.50f, 0.90f, 0.30f);
