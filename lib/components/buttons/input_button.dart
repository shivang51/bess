...
class InputButton extends Component{
  ...
  static void create(BuildContext context){
    ...
    var pin = Pin(pinId, behaviour: PinBehaviour.output, parentId: buttonId,);
    (pin.properties as PinProperties).offset = const Offset(45.0, 11.5);
