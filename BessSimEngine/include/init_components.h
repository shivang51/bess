...
namespace Bess::SimEngine {
    ...
    inline void initComponentCatalog() {
        ...
        ComponentCatalog::instance().registerComponent(ComponentDefinition(ComponentType::XNOR, "XNOR Gate", "Digital Gates", 2, 1, [](entt::registry &registry, entt::entity e, auto fn) -> bool {
                                                            auto &gate = registry.get<GateComponent>(e);
                                                            std::vector<bool> pinValues;
                                                            for (const auto &pin : gate.inputPins) {
                                                                bool pinState = false;
        ...
        auto nandGate = ComponentDefinition(ComponentType::NAND, "NAND Gate", "Digital Gates", 2, 1, [](entt::registry &registry, entt::entity e, auto fn) -> bool {
                                           auto &gate = registry.get<GateComponent>(e);
                                           std::vector<bool> pinValues;
                                           for (const auto &pin : gate.inputPins) {
                                               bool pinState = false;
        ...
        ComponentCatalog::instance().registerComponent(ComponentDefinition(ComponentType::NOR, "NOR Gate", "Digital Gates", 2, 1, [](entt::registry &registry, entt::entity e, auto fn) -> bool {
                                                            auto &gate = registry.get<GateComponent>(e);
                                                            std::vector<bool> pinValues;
                                                            for (const auto &pin : gate.inputPins) {
                                                                bool pinState = false;
